...
const Button = ({ white, path }) => {
  ...
  const animateArrowIcon = async (pathLengthCircle, arrowMoveVal, arrowTwoMoveVal) => {
    await Promise.all([
  ...
  return (
    ...
    >
      <StyledArrowWrapper>
        <StyledArrowIcon viewBox='0 0 69 69' xmlns='http://www.w3.org/2000/svg' white={white}>
          <motion.path
      ...
      <span className='text-semibold content'>Discover more</span>
    </StyledButton>
  );
};
